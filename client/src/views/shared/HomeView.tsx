...
const HomeView: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/search" className="px-8 py-3 rounded-lg bg-gradient-purple text-white font-semibold hover:shadow-lg transition-all">
                Find Clinics
              </Link>
          ...
          <div className="relative h-96 md:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
            <div className="w-full h-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-white font-semibold">Medical Professional</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="services" className="py-20 md:py-32 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: 'stethoscope', title: 'Urology', desc: 'Our urology department provides expert care for conditions affecting the urinary system and male reproductive health.' },
              { icon: 'brain', title: 'Neurology', desc: 'Our neurology department provides expert care for conditions affecting the brain, spine, and nervous system.' },
              { icon: 'eye', title: 'Eye Care', desc: 'Our eye care specialists provide comprehensive vision care and treatment for all eye conditions.' }
            ].map((service, idx) => (
              <div key={idx} className="bg-gradient-to-br from-neutral-50 to-white border border-neutral-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:border-primary-300">
      ...
      <section id="why-us" className="py-20 md:py-32 bg-gradient-to-br from-neutral-50 to-primary-50">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="relative h-96 md:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
            <div className="w-full h-full bg-gradient-to-br from-primary-300 to-primary-600 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-white font-semibold">Healthcare Expert</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <button className="mt-10 px-8 py-3 rounded-lg bg-gradient-purple text-white font-semibold hover:shadow-lg transition-all">
              View More About Us
            </button>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-20 md:py-32 bg-gradient-purple text-white">
