              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <button 
                    ...
                    className="flex-1 py-2 px-4 rounded-lg bg-gradient-purple text-white font-semibold hover:shadow-lg transition-all"
                  >
                    Book Now
                  </button>
                  <button 
                    onClick={() => navigate(`/clinic/${clinic.id}`)}
                    className="flex-1 py-2 px-4 rounded-lg border border-neutral-300 text-neutral-700 hover:bg-neutral-50 font-semibold transition-colors"
                  >
                    View Details
                  </button>
                </div>
